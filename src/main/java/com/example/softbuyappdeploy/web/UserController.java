...
public class  UserController extends BaseController {
    ...
    public String register(@Valid @ModelAttribute(name = "user") UserEntityDTO user, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        UserEntityDTO registeredUser = userServiceImpl.registerUser(user.getUserName(), user.getFirstName(), user.getLastName(), user.getEmail(), user.getPassword(),user.getRole());
